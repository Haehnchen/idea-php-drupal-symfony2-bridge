 ...
 */
public class PermissionIndex extends FileBasedIndexExtension<String, Void> {

    public static final ID<String, Void> KEY = ID.create("de.espend.idea.php.drupal.permission_keys");
